...
@ApplicationScoped
public class ChatClient extends ConnectClientBase<ChatServiceClient> {
    ...
    protected ConnectionConfig getConnectionConfig(Context context, DefaultConfig defaultConfig) {
        ...
        return new ConnectionConfig(
                cfg.chatHostUrl(), cfg.chatHostPort(), cfg.authInterceptorEnabled());
    }

    public ChatServiceClient stub(Context context) {
        return new ChatServiceClient(getProtocolClient());
    }
}
