...
const (
	PropertyService_AddPropertyType_FullMethodName    = "/apis.PropertyService/AddPropertyType"
	PropertyService_ListType_FullMethodName           = "/apis.PropertyService/ListType"
	PropertyService_AddLocality_FullMethodName        = "/apis.PropertyService/AddLocality"
	PropertyService_DeleteLocality_FullMethodName     = "/apis.PropertyService/DeleteLocality"
	PropertyService_CreateProperty_FullMethodName     = "/apis.PropertyService/CreateProperty"
	PropertyService_UpdateProperty_FullMethodName     = "/apis.PropertyService/UpdateProperty"
	PropertyService_DeleteProperty_FullMethodName     = "/apis.PropertyService/DeleteProperty"
	PropertyService_StateOfProperty_FullMethodName    = "/apis.PropertyService/StateOfProperty"
	PropertyService_HistoryOfProperty_FullMethodName  = "/apis.PropertyService/HistoryOfProperty"
	PropertyService_SearchProperty_FullMethodName     = "/apis.PropertyService/SearchProperty"
	PropertyService_ListSubscriptions_FullMethodName  = "/apis.PropertyService/ListSubscriptions"
	PropertyService_AddSubscription_FullMethodName    = "/apis.PropertyService/AddSubscription"
	PropertyService_DeleteSubscription_FullMethodName = "/apis.PropertyService/DeleteSubscription"
)
...
func (c *propertyServiceClient) ListType(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (PropertyService_ListTypeClient, error) {
	stream, err := c.cc.NewStream(ctx, &PropertyService_ServiceDesc.Streams[0], PropertyService_ListType_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *propertyServiceClient) ListSubscriptions(ctx context.Context, in *SubscriptionListRequest, opts ...grpc.CallOption) (PropertyService_ListSubscriptionsClient, error) {
	stream, err := c.cc.NewStream(ctx, &PropertyService_ServiceDesc.Streams[3], PropertyService_ListSubscriptions_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
