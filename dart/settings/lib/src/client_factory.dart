...
/// Factory for creating configured Settings service client interceptors.
///
/// Provides convenient methods to create interceptors with automatic token refresh.
/// Use these interceptors when creating your Transport for the SettingsServiceClient.
///
/// ## Example
///
/// ```dart
...
class SettingsClientFactory {
  ...
  ///
  /// ```dart
  /// final interceptors = SettingsClientFactory.createCustomAuthInterceptors(
