...
/// Default endpoint for the Settings service.
const String defaultSettingsEndpoint = 'https://settings.antinvestor.com';

/// Creates a new Settings service client.
///
/// This is the Dart equivalent of Go's `settings.NewClient()`.
...
/// Type alias for Settings client for convenience.
