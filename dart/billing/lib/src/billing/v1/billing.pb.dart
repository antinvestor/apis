...
class UsageEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UsageEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'billing.v1'), createEmptyInstance: create)
    ...
    ..aOM<$3.Interval>(11, _omitFieldNames ? '' : 'interval', subBuilder: $3.Interval.create)
    ..aOS(12, _omitFieldNames ? '' : 'unit')
    ..aOM<$2.Money>(13, _omitFieldNames ? '' : 'amount', subBuilder: $2.Money.create)
  ...
  @$pb.TagNumber(11)
  $3.Interval get interval => $_getN(7);
  @$pb.TagNumber(11)
  set interval($3.Interval v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasInterval() => $_has(7);
  @$pb.TagNumber(11)
  void clearInterval() => clearField(11);
  @$pb.TagNumber(11)
  $3.Interval ensureInterval() => $_ensure(7);
  ...
  @$pb.TagNumber(13)
  $2.Money get amount => $_getN(9);
  @$pb.TagNumber(13)
  set amount($2.Money v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasAmount() => $_has(9);
  @$pb.TagNumber(13)
  void clearAmount() => clearField(13);
  @$pb.TagNumber(13)
  $2.Money ensureAmount() => $_ensure(9);
...
class BillingServiceApi {
  ...
  ;
  $async.Future<SearchCatalogVersionsResponse> searchCatalogVersions($pb.ClientContext? ctx, $4.SearchRequest request) =>
  ...
  ;
  $async.Future<SearchUsageEventsResponse> searchUsageEvents($pb.ClientContext? ctx, $4.SearchRequest request) =>
  ...
  ;
  $async.Future<SearchInvoicesResponse> searchInvoices($pb.ClientContext? ctx, $4.SearchRequest request) =>
  ...
  ;
  $async.Future<SearchDiscountsResponse> searchDiscounts($pb.ClientContext? ctx, $4.SearchRequest request) =>
