...
/// Factory for creating configured Property service client interceptors.
///
/// Provides convenient methods to create interceptors with automatic token refresh.
/// Use these interceptors when creating your Transport for the PropertyServiceClient.
///
/// ## Example
///
/// ```dart
...
class PropertyClientFactory {
  ...
  ///
  /// ```dart
  /// final interceptors = PropertyClientFactory.createCustomAuthInterceptors(
