...
/// Factory for creating configured Payment service client interceptors.
///
/// Provides convenient methods to create interceptors with automatic token refresh.
/// Use these interceptors when creating your Transport for the PaymentServiceClient.
///
/// ## Example
///
/// ```dart
...
class PaymentClientFactory {
  ...
  ///
  /// ```dart
  /// final interceptors = PaymentClientFactory.createCustomAuthInterceptors(
