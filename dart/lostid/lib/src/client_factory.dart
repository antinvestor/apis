...
/// Factory for creating configured Lostid service client interceptors.
///
/// Provides convenient methods to create interceptors with automatic token refresh.
/// Use these interceptors when creating your Transport for the LostidServiceClient.
///
/// ## Example
///
/// ```dart
...
class LostidClientFactory {
  ...
  ///
  /// ```dart
  /// final interceptors = LostidClientFactory.createCustomAuthInterceptors(
