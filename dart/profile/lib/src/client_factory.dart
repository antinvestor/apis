...
import '../antinvestor_profile.dart';

/// Factory for creating configured Profile service clients.
///
...
class ProfileClientFactory {
  /// Creates a Profile service client with token refresh interceptor.
  ///
  /// ## Parameters
  ///
  ...
  ///
  /// ```dart
  /// final client = ProfileClientFactory.create(
  ...
  /// );
  /// ```
  static ProfileServiceClient create({
    ...
    return ServiceClientFactory.create<ProfileServiceClient>(
      baseUrl: baseUrl,
      tokenManager: tokenManager,
      onTokenRefresh: onTokenRefresh,
      clientBuilder: (channel, interceptors) {
        return ProfileServiceClient(channel, interceptors: interceptors);
      },
  ...
  /// Creates a Profile service client without authentication.
  ///
  /// See [ServiceClientFactory.createUnauthenticated] for detailed documentation.
  static ProfileServiceClient createUnauthenticated({
    required String baseUrl,
    List<ClientInterceptor>? interceptors,
    ChannelOptions? channelOptions,
  }) {
    return ServiceClientFactory.createUnauthenticated<ProfileServiceClient>(
      baseUrl: baseUrl,
      clientBuilder: (channel, interceptors) {
        return ProfileServiceClient(channel, interceptors: interceptors);
      },
  ...
  /// Creates a Profile service client with a custom token provider.
  ///
  /// See [ServiceClientFactory.createWithTokenProvider] for detailed documentation.
  static ProfileServiceClient createWithTokenProvider({
    required String baseUrl,
    ...
    return ServiceClientFactory.createWithTokenProvider<ProfileServiceClient>(
      baseUrl: baseUrl,
