...
/// Factory for creating configured Profile service client interceptors.
///
/// Provides convenient methods to create interceptors with automatic token refresh.
/// Use these interceptors when creating your Transport for the ProfileServiceClient.
///
/// ## Example
///
/// ```dart
...
class ProfileClientFactory {
  ...
  ///
  /// ```dart
  /// final interceptors = ProfileClientFactory.createCustomAuthInterceptors(
