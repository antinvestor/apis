...
abstract class ProfileServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String methodName, $pb.GeneratedMessage request) {
    switch (methodName) {
      case 'GetById': return this.getById(ctx, request as $2.GetByIdRequest);
      case 'GetByContact': return this.getByContact(ctx, request as $2.GetByContactRequest);
      case 'Search': return this.search(ctx, request as $2.SearchRequest);
      case 'Merge': return this.merge(ctx, request as $2.MergeRequest);
      case 'Create': return this.create(ctx, request as $2.CreateRequest);
      case 'Update': return this.update(ctx, request as $2.UpdateRequest);
      case 'AddContact': return this.addContact(ctx, request as $2.AddContactRequest);
      case 'CreateContact': return this.createContact(ctx, request as $2.CreateContactRequest);
      case 'CreateContactVerification': return this.createContactVerification(ctx, request as $2.CreateContactVerificationRequest);
      case 'CheckVerification': return this.checkVerification(ctx, request as $2.CheckVerificationRequest);
      case 'RemoveContact': return this.removeContact(ctx, request as $2.RemoveContactRequest);
      case 'SearchRoster': return this.searchRoster(ctx, request as $2.SearchRosterRequest);
      case 'AddRoster': return this.addRoster(ctx, request as $2.AddRosterRequest);
      case 'RemoveRoster': return this.removeRoster(ctx, request as $2.RemoveRosterRequest);
      case 'AddAddress': return this.addAddress(ctx, request as $2.AddAddressRequest);
      case 'AddRelationship': return this.addRelationship(ctx, request as $2.AddRelationshipRequest);
      case 'DeleteRelationship': return this.deleteRelationship(ctx, request as $2.DeleteRelationshipRequest);
      case 'ListRelationship': return this.listRelationship(ctx, request as $2.ListRelationshipRequest);
      default: throw $core.ArgumentError('Unknown method: $methodName');
    }
  }
