...
import '../antinvestor_partition.dart';

/// Factory for creating configured Partition service clients.
///
...
class PartitionClientFactory {
  /// Creates a Partition service client with token refresh interceptor.
  ///
  /// ## Parameters
  ///
  ...
  ///
  /// ```dart
  /// final client = PartitionClientFactory.create(
  ...
  /// );
  /// ```
  static PartitionServiceClient create({
    ...
    return ServiceClientFactory.create<PartitionServiceClient>(
      baseUrl: baseUrl,
      tokenManager: tokenManager,
      onTokenRefresh: onTokenRefresh,
      clientBuilder: (channel, interceptors) {
        return PartitionServiceClient(channel, interceptors: interceptors);
      },
  ...
  /// Creates a Partition service client without authentication.
  ///
  /// See [ServiceClientFactory.createUnauthenticated] for detailed documentation.
  static PartitionServiceClient createUnauthenticated({
    required String baseUrl,
    List<ClientInterceptor>? interceptors,
    ChannelOptions? channelOptions,
  }) {
    return ServiceClientFactory.createUnauthenticated<PartitionServiceClient>(
      baseUrl: baseUrl,
      clientBuilder: (channel, interceptors) {
        return PartitionServiceClient(channel, interceptors: interceptors);
      },
  ...
  /// Creates a Partition service client with a custom token provider.
  ///
  /// See [ServiceClientFactory.createWithTokenProvider] for detailed documentation.
  static PartitionServiceClient createWithTokenProvider({
    required String baseUrl,
    ...
    return ServiceClientFactory.createWithTokenProvider<PartitionServiceClient>(
      baseUrl: baseUrl,
