...
/// Factory for creating configured Ocr service client interceptors.
///
/// Provides convenient methods to create interceptors with automatic token refresh.
/// Use these interceptors when creating your Transport for the OcrServiceClient.
///
/// ## Example
///
/// ```dart
...
class OcrClientFactory {
  ...
  ///
  /// ```dart
  /// final interceptors = OcrClientFactory.createCustomAuthInterceptors(
