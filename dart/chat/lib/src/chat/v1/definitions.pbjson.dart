...
const RoomEventType$json = {
  ...
  '2': [
    ...
    {'1': 'ROOM_EVENT_TYPE_MESSAGE', '2': 2},
    {'1': 'ROOM_EVENT_TYPE_REACTION', '2': 3},
    {'1': 'ROOM_EVENT_TYPE_CALL', '2': 5},
    {'1': 'ROOM_EVENT_TYPE_ADVERT', '2': 6},
  ],
};
...
final $typed_data.Uint8List roomEventTypeDescriptor = $convert.base64Decode(
    ...
    '1fRVZFTlRfVFlQRV9TWVNURU0QARIbChdST09NX0VWRU5UX1RZUEVfTUVTU0FHRRACEhwKGFJP'
    'T01fRVZFTlRfVFlQRV9SRUFDVElPThADEhgKFFJPT01fRVZFTlRfVFlQRV9DQUxMEAUSGgoWUk'
    '9PTV9FVkVOVF9UWVBFX0FEVkVSVBAG');
