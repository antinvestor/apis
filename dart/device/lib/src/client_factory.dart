...
/// Factory for creating configured Device service client interceptors.
///
/// Provides convenient methods to create interceptors with automatic token refresh.
/// Use these interceptors when creating your Transport for the DeviceServiceClient.
///
/// ## Example
///
/// ```dart
...
class DeviceClientFactory {
  ...
  ///
  /// ```dart
  /// final interceptors = DeviceClientFactory.createCustomAuthInterceptors(
