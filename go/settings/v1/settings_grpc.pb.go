...
func (c *settingsServiceClient) List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (SettingsService_ListClient, error) {
	stream, err := c.cc.NewStream(ctx, &SettingsService_ServiceDesc.Streams[0], SettingsService_List_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *settingsServiceClient) Set(ctx context.Context, in *SetRequest, opts ...grpc.CallOption) (*SetResponse, error) {
	out := new(SetResponse)
	err := c.cc.Invoke(ctx, SettingsService_Set_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
