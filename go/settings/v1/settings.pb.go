...
const file_settings_v1_settings_proto_rawDesc = "" +
	...
	"\xbaH\a\xd8\x01\x00r\x02\x10\x02R\x06object\x12;\n" +
	"\tobject_id\x18\x03 \x01(\tB\x1e\xbaH\x1b\xd8\x01\x00r\x16\x10\x03\x18(2\x10[0-9a-z_-]{3,20}R\bobjectId\x12\x1e\n" +
	"\x04lang\x18\x04 \x01(\tB\n" +
	"\xbaH\a\xd8\x01\x00r\x02\x10\x02R\x04lang\x12\"\n" +
	"\x06module\x18\x05 \x01(\tB\n" +
	"\xbaH\a\xd8\x01\x00r\x02\x10\x03R\x06module\"\x94\x01\n" +
	"\rSettingObject\x12+\n" +
	...
	"\vSetResponse\x12.\n" +
	"\x04data\x18\x01 \x01(\v2\x1a.settings.v1.SettingObjectR\x04data2\xc3\x02\n" +
	"\x0fSettingsService\x12C\n" +
	"\x03Get\x12\x17.settings.v1.GetRequest\x1a\x18.settings.v1.GetResponse\"\t\x82\xd3\xe4\x93\x02\x03\x12\x01/\x12L\n" +
	"\x04List\x12\x18.settings.v1.ListRequest\x1a\x19.settings.v1.ListResponse\"\r\x82\xd3\xe4\x93\x02\a\x12\x05/list0\x01\x12R\n" +
	"\x06Search\x12\x18.common.v1.SearchRequest\x1a\x1b.settings.v1.SearchResponse\"\x0f\x82\xd3\xe4\x93\x02\t\x12\a/search0\x01\x12I\n" +
	"\x03Set\x12\x17.settings.v1.SetRequest\x1a\x18.settings.v1.SetResponse\"\x0f\x82\xd3\xe4\x93\x02\t:\x01*\"\x04/setB\xc7\x03\x92A\x85\x02\x12r\n" +
	"\x10Settings Service\"Y\n" +
	"\x10Ant Investor Ltd\x12/https://github.com/antinvestor/service-settings\x1a\x14info@antinvestor.com2\x031.0*\x02\x01\x022\x10application/json:\x10application/jsonZY\n" +
	"W\n" +
	"\x06bearer\x12M\b\x02\x128Authentication token, prefixed by Bearer: Bearer <token>\x1a\rAuthorization \x02b\f\n" +
	"\n" +
	"\n" +
	"\x06bearer\x12\x00\n" +
	" com.antinvestor.apis.settings.v1B\rSettingsProtoP\x01Z>github.com/antinvestor/apis/go/settings/settings/v1;settingsv1\xa2\x02\x03SXX\xaa\x02\vSettings.V1\xca\x02\vSettings\\V1\xe2\x02\x17Settings\\V1\\GPBMetadata\xea\x02\fSettings::V1b\x06proto3"
