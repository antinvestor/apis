...
// SettingsClient is a svc for interacting with the notification service API.
//
...
// NewsettingsClient creates a new notification svc.
//
...
func NewsettingsClient(ctx context.Context, opts ...common.ClientOption) (*SettingsClient, error) {
	...
	return Init(clientBase, NewSettingsServiceClient(clientBase.Connection())), nil
}

func (sc *SettingsClient) Svc() SettingsServiceClient {
	return sc.svc
}
