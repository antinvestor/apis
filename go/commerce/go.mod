module github.com/antinvestor/apis/go/commerce
...
require (
	buf.build/gen/go/antinvestor/commerce/protocolbuffers/go v1.36.11-20260203091223-77ee0776a762.1 // indirect
