...
const file_common_v1_common_proto_rawDesc = "" +
	...
	"\bend_date\x18\x04 \x01(\tR\aendDate\"\x88\x02\n" +
	...
	"properties\x12<\n" +
	"\x06extras\x18\b \x03(\v2$.common.v1.SearchRequest.ExtrasEntryR\x06extras\x1a9\n" +
	...
	"\x06extras\x18\x02 \x03(\v2$.common.v1.StatusRequest.ExtrasEntryR\x06extras\x1a9\n" +
	"\vExtrasEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\x06extras\x18\x06 \x03(\v2%.common.v1.StatusResponse.ExtrasEntryR\x06extras\x1a9\n" +
	"\vExtrasEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\vexternal_id\x18\x04 \x01(\tR\n" +
	"externalId\x12B\n" +
	"\x06extras\x18\x05 \x03(\v2*.common.v1.StatusUpdateRequest.ExtrasEntryR\x06extras\x1a9\n" +
	"\vExtrasEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"E\n" +
	"\x14StatusUpdateResponse\x12-\n" +
	"\x04data\x18\x01 \x01(\v2\x19.common.v1.StatusResponseR\x04data\"\x90\x04\n" +
	"\vContactLink\x12C\n" +
	"\fprofile_name\x18\x01 \x01(\tB \xbaH\x1d\xd8\x01\x00r\x18\x10\x03\x18\xfa\x012\x11[0-9a-z_-]{3,250}R\vprofileName\x12C\n" +
	"\fprofile_type\x18\x02 \x01(\tB \xbaH\x1d\xd8\x01\x00r\x18\x10\x03\x18\xfa\x012\x11[0-9a-z_-]{3,250}R\vprofileType\x12=\n" +
	"\n" +
	"profile_id\x18\x03 \x01(\tB\x1e\xbaH\x1b\xd8\x01\x00r\x16\x10\x03\x18(2\x10[0-9a-z_-]{3,40}R\tprofileId\x12H\n" +
	"\x10profile_image_id\x18\x04 \x01(\tB\x1e\xbaH\x1b\xd8\x01\x00r\x16\x10\x03\x18(2\x10[0-9a-z_-]{3,40}R\x0eprofileImageId\x12=\n" +
	"\n" +
	"contact_id\x18\b \x01(\tB\x1e\xbaH\x1b\xd8\x01\x00r\x16\x10\x03\x18(2\x10[0-9a-z_-]{3,40}R\tcontactId\x128\n" +
	"\x06detail\x18\t \x01(\tB \xbaH\x1d\xd8\x01\x00r\x18\x10\x03\x18\xfa\x012\x11[0-9a-z_-]{3,250}R\x06detail\x12:\n" +
	"\x06extras\x18\n" +
	" \x03(\v2\".common.v1.ContactLink.ExtrasEntryR\x06extras\x1a9\n" +
	"\vExtrasEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
