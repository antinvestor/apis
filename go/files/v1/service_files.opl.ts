...
class service_files implements Namespace {
  related: {
    owner: profile_user[]
    admin: profile_user[]
    ...
    granted_content_view: (profile_user | service_files)[]
    granted_content_upload: (profile_user | service_files)[]
    granted_content_manage: (profile_user | service_files)[]
    granted_content_delete: (profile_user | service_files)[]
    granted_file_access_view: (profile_user | service_files)[]
    granted_file_access_manage: (profile_user | service_files)[]
  }
