...
require (
	buf.build/gen/go/antinvestor/profile/connectrpc/go v1.19.1-20251223045456-5ee7a5832a2e.2
	buf.build/gen/go/antinvestor/profile/protocolbuffers/go v1.36.11-20251223045456-5ee7a5832a2e.1
