...
type Locality struct {
	...
	Id          string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`                                // Unique locality ID
	ParentId    string                 `protobuf:"bytes,2,opt,name=parent_id,json=parentId,proto3" json:"parent_id,omitempty"`    // Parent locality ID for hierarchical structure
	Name        string                 `protobuf:"bytes,5,opt,name=name,proto3" json:"name,omitempty"`                            // Locality name (city, district, neighborhood)
	Description string                 `protobuf:"bytes,6,opt,name=description,proto3" json:"description,omitempty"`              // Detailed description
	Extras      *structpb.Struct       `protobuf:"bytes,7,opt,name=extras,proto3" json:"extras,omitempty"`                        // Additional metadata
...
type Locality_Point struct {
	Point string `protobuf:"bytes,3,opt,name=point,proto3,oneof"` // Point location (lat,lng format)
}

type Locality_Boundary struct {
	Boundary string `protobuf:"bytes,4,opt,name=boundary,proto3,oneof"` // Boundary polygon (GeoJSON or WKT format)
}
...
type PropertyType struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`                                // Unique property type ID
	Name          string                 `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`                            // Type name (residential, commercial, land, etc.)
	Description   string                 `protobuf:"bytes,3,opt,name=description,proto3" json:"description,omitempty"`              // Type description
...
type PropertyState struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`                                // Unique state record ID
	Propertyid    string                 `protobuf:"bytes,2,opt,name=propertyid,proto3" json:"propertyid,omitempty"`                // Associated property ID
	State         v1.STATE               `protobuf:"varint,3,opt,name=state,proto3,enum=common.v1.STATE" json:"state,omitempty"`    // Property state
	Status        v1.STATUS              `protobuf:"varint,4,opt,name=status,proto3,enum=common.v1.STATUS" json:"status,omitempty"` // Property status
	Name          string                 `protobuf:"bytes,5,opt,name=name,proto3" json:"name,omitempty"`                            // State name/label
	Description   string                 `protobuf:"bytes,6,opt,name=description,proto3" json:"description,omitempty"`              // State description
	Extras        *structpb.Struct       `protobuf:"bytes,7,opt,name=extras,proto3" json:"extras,omitempty"`                        // Additional metadata
	CreatedAt     *timestamppb.Timestamp `protobuf:"bytes,8,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"` // State timestamp
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Subscription struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`                                   // Unique subscription ID
	PropertyId    string                 `protobuf:"bytes,2,opt,name=property_id,json=propertyId,proto3" json:"property_id,omitempty"` // Property ID
	ProfileId     string                 `protobuf:"bytes,3,opt,name=profile_id,json=profileId,proto3" json:"profile_id,omitempty"`    // Profile ID of subscriber
	Role          string                 `protobuf:"bytes,4,opt,name=role,proto3" json:"role,omitempty"`                               // Role (owner, manager, tenant, viewer, etc.)
	Extra         *structpb.Struct       `protobuf:"bytes,5,opt,name=extra,proto3" json:"extra,omitempty"`                             // Additional metadata
	CreatedAt     *timestamppb.Timestamp `protobuf:"bytes,6,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`    // Subscription start
	ExpiresAt     *timestamppb.Timestamp `protobuf:"bytes,7,opt,name=expires_at,json=expiresAt,proto3" json:"expires_at,omitempty"`    // Subscription expiry
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Property struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`                                         // Unique property ID
	ParentId      string                 `protobuf:"bytes,2,opt,name=parent_id,json=parentId,proto3" json:"parent_id,omitempty"`             // Parent property ID for hierarchical structures
	Name          string                 `protobuf:"bytes,3,opt,name=name,proto3" json:"name,omitempty"`                                     // Property name
	Description   string                 `protobuf:"bytes,4,opt,name=description,proto3" json:"description,omitempty"`                       // Property description
	PropertyType  *PropertyType          `protobuf:"bytes,5,opt,name=property_type,json=propertyType,proto3" json:"property_type,omitempty"` // Property classification
	Locality      *Locality              `protobuf:"bytes,6,opt,name=locality,proto3" json:"locality,omitempty"`                             // Geographic location
	StartedAt     *timestamppb.Timestamp `protobuf:"bytes,7,opt,name=started_at,json=startedAt,proto3" json:"started_at,omitempty"`          // Property start date
	CreatedAt     *timestamppb.Timestamp `protobuf:"bytes,8,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`          // Creation timestamp
	Extra         *structpb.Struct       `protobuf:"bytes,9,opt,name=extra,proto3" json:"extra,omitempty"`                                   // Additional property metadata
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_property_v1_property_proto_rawDesc = "" +
	"\n" +
	"\x1aproperty/v1/property.proto\x12\vproperty.v1\x1a\x1bbuf/validate/validate.proto\x1a\x16common/v1/common.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a$gnostic/openapi/v3/annotations.proto\"\x95\x03\n" +
	"\bLocality\x12.\n" +
	...
	"\x04data\x18\x01 \x01(\v2\x15.property.v1.LocalityR\x04data\"\xf5\x01\n" +
	"\fPropertyType\x12.\n" +
	...
	"\n" +
	"created_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\"\x85\x03\n" +
	"\rPropertyState\x12+\n" +
	...
	"\x04name\x18\x04 \x01(\tB\f\xbaH\t\xd8\x01\x01r\x04\x10\x03\x18<R\x04name\x12,\n" +
	"\vdescription\x18\x05 \x01(\tB\n" +
	"\xbaH\a\xd8\x01\x01r\x02\x10<R\vdescription\x12?\n" +
	...
	"\asuccess\x18\x01 \x01(\bR\asuccess2\xe2\x1c\n" +
	"\x0fPropertyService\x12\x86\x02\n" +
	"\x0fAddPropertyType\x12#.property.v1.AddPropertyTypeRequest\x1a$.property.v1.AddPropertyTypeResponse\"\xa7\x01\xbaG\xa3\x01\n" +
	"\x0eProperty Types\x12\x11Add property type\x1amCreates a new property type classification (residential, commercial, land, etc.) for categorizing properties.*\x0faddPropertyType\x12\xa8\x02\n" +
	"\x10ListPropertyType\x12$.property.v1.ListPropertyTypeRequest\x1a%.property.v1.ListPropertyTypeResponse\"\xc4\x01\xbaG\xc0\x01\n" +
	"\x0eProperty Types\x12\x13List property types\x1a\x85\x01Retrieves all property type classifications with optional filtering by date range and properties. Returns a stream of property types.*\x11listPropertyTypes0\x01\x12\xfa\x01\n" +
	"\vAddLocality\x12\x1f.property.v1.AddLocalityRequest\x1a .property.v1.AddLocalityResponse\"\xa7\x01\xbaG\xa3\x01\n" +
	"\n" +
	"Localities\x12\fAdd locality\x1azCreates a new geographic locality with geospatial features (point or boundary). Supports hierarchical locality structures.*\vaddLocality\x12\x80\x02\n" +
	"\x0eDeleteLocality\x12\".property.v1.DeleteLocalityRequest\x1a#.property.v1.DeleteLocalityResponse\"\xa4\x01\xbaG\xa0\x01\n" +
	"\n" +
	"Localities\x12\x0fDelete locality\x1aqRemoves a geographic locality from the system. Properties associated with this locality must be reassigned first.*\x0edeleteLocality\x12\xa8\x02\n" +
	"\x0eCreateProperty\x12\".property.v1.CreatePropertyRequest\x1a#.property.v1.CreatePropertyResponse\"\xcc\x01\xbaG\xc8\x01\n" +
	"\n" +
	"Properties\x12\x0fCreate property\x1a\x98\x01Creates a new property with type classification, locality, and optional hierarchical parent. Properties can represent buildings, units, or land parcels.*\x0ecreateProperty\x12\x9d\x02\n" +
	"\x0eUpdateProperty\x12\".property.v1.UpdatePropertyRequest\x1a#.property.v1.UpdatePropertyResponse\"\xc1\x01\xbaG\xbd\x01\n" +
	"\n" +
	"Properties\x12\x0fUpdate property\x1a\x8d\x01Updates an existing property's details including state, status, name, description, guardian, and locality. Creates a new state history entry.*\x0eupdateProperty\x12\xec\x01\n" +
	"\x0eDeleteProperty\x12\".property.v1.DeletePropertyRequest\x1a#.property.v1.DeletePropertyResponse\"\x90\x01\xbaG\x8c\x01\n" +
	"\n" +
	"Properties\x12\x0fDelete property\x1a]Removes a property from the system. Child properties and subscriptions must be removed first.*\x0edeleteProperty\x12\xfe\x01\n" +
	"\x0fStateOfProperty\x12#.property.v1.StateOfPropertyRequest\x1a$.property.v1.StateOfPropertyResponse\"\x9f\x01\xbaG\x9b\x01\n" +
	"\n" +
	"Properties\x12\x12Get property state\x1agRetrieves the current state and status of a property including the latest state transition information.*\x10getPropertyState\x12\xb0\x02\n" +
	"\x11HistoryOfProperty\x12%.property.v1.HistoryOfPropertyRequest\x1a&.property.v1.HistoryOfPropertyResponse\"\xc9\x01\xbaG\xc5\x01\n" +
	"\n" +
	"Properties\x12\x14Get property history\x1a\x8c\x01Retrieves the complete state transition history of a property over its lifetime. Returns a stream of state snapshots in chronological order.*\x12getPropertyHistory0\x01\x12\xb5\x02\n" +
	"\x0eSearchProperty\x12\".property.v1.SearchPropertyRequest\x1a#.property.v1.SearchPropertyResponse\"\xd7\x01\xbaG\xd3\x01\n" +
	"\n" +
	"Properties\x12\x11Search properties\x1a\x9f\x01Searches for properties matching specified criteria including name, type, locality, date range, and custom properties. Returns a stream of matching properties.*\x10searchProperties0\x01\x12\xa0\x02\n" +
	"\x10ListSubscription\x12$.property.v1.ListSubscriptionRequest\x1a%.property.v1.ListSubscriptionResponse\"\xbc\x01\xbaG\xb8\x01\n" +
	"\rSubscriptions\x12\x1bList property subscriptions\x1awRetrieves all subscriptions (access grants) for a specific property including profile IDs, roles, and expiration dates.*\x11listSubscriptions0\x01\x12\xa7\x02\n" +
	"\x0fAddSubscription\x12#.property.v1.AddSubscriptionRequest\x1a$.property.v1.AddSubscriptionResponse\"\xc8\x01\xbaG\xc4\x01\n" +
	"\rSubscriptions\x12\x10Add subscription\x1a\x8f\x01Grants a profile access to a property with a specific role (owner, manager, tenant, viewer). Supports expiration dates for time-limited access.*\x0faddSubscription\x12\xa7\x02\n" +
	"\x12DeleteSubscription\x12&.property.v1.DeleteSubscriptionRequest\x1a'.property.v1.DeleteSubscriptionResponse\"\xbf\x01\xbaG\xbb\x01\n" +
	"\rSubscriptions\x12\x13Delete subscription\x1a\x80\x01Revokes a profile's access to a property by removing their subscription. The profile will no longer have access to the property.*\x12deleteSubscriptionB\x9e\x06\xbaG\xe5\x04\x12\xb9\x04\n" +
	"\x10Property Service\x12\xf6\x02The Property Service manages real estate and asset properties with geospatial locality tracking, hierarchical structures, and subscription-based access control. It supports property type classification, state history tracking, and role-based subscriptions. Properties can be organized hierarchically and associated with geographic localities defined by points or boundaries.\"Y\n" +
	"\x10Ant Investor Ltd\x12/https://github.com/antinvestor/service-property\x1a\x14info@antinvestor.com*I\n" +
	...
	" com.antinvestor.apis.property.v1B\rPropertyProtoP\x01Z5github.com/antinvestor/apis/go/property/v1;propertyv1\xa2\x02\x03PXX\xaa\x02\vProperty.V1\xca\x02\vProperty\\V1\xe2\x02\x17Property\\V1\\GPBMetadata\xea\x02\fProperty::V1b\x06proto3"
...
var file_property_v1_property_proto_goTypes = []any{
	...
	(*PropertyType)(nil),               // 3: property.v1.PropertyType
	(*PropertyState)(nil),              // 4: property.v1.PropertyState
...
var file_property_v1_property_proto_depIdxs = []int32{
	...
	31, // 4: property.v1.PropertyType.extra:type_name -> google.protobuf.Struct
	32, // 5: property.v1.PropertyType.created_at:type_name -> google.protobuf.Timestamp
	33, // 6: property.v1.PropertyState.state:type_name -> common.v1.STATE
	34, // 7: property.v1.PropertyState.status:type_name -> common.v1.STATUS
	31, // 8: property.v1.PropertyState.extras:type_name -> google.protobuf.Struct
	32, // 9: property.v1.PropertyState.created_at:type_name -> google.protobuf.Timestamp
	3,  // 10: property.v1.AddPropertyTypeRequest.data:type_name -> property.v1.PropertyType
	3,  // 11: property.v1.AddPropertyTypeResponse.data:type_name -> property.v1.PropertyType
	...
	3,  // 17: property.v1.Property.property_type:type_name -> property.v1.PropertyType
	...
	3,  // 25: property.v1.ListPropertyTypeResponse.data:type_name -> property.v1.PropertyType
	...
	4,  // 28: property.v1.StateOfPropertyResponse.data:type_name -> property.v1.PropertyState
	4,  // 29: property.v1.HistoryOfPropertyResponse.data:type_name -> property.v1.PropertyState
