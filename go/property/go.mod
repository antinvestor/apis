...
require (
	buf.build/gen/go/antinvestor/property/connectrpc/go v1.19.1-20251222130747-1ed48d0d12d2.2
	buf.build/gen/go/antinvestor/property/protocolbuffers/go v1.36.11-20251222130747-1ed48d0d12d2.1
