...
type TemplateSearchRequest struct {
	...
	Data *v1.SearchRequest `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`
}
...
func (x *TemplateSearchRequest) GetData() *v1.SearchRequest {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_notification_v1_notification_proto_rawDesc = []byte{
	...
	0x31, 0x2e, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x52,
	0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x47, 0x0a, 0x16, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74,
	...
	0x02, 0x32, 0x81, 0x05, 0x0a, 0x13, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69,
	...
	0x01, 0x12, 0x55, 0x0a, 0x0e, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x53, 0x65, 0x61,
	0x72, 0x63, 0x68, 0x12, 0x18, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x2e,
	...
	,
...
var file_notification_v1_notification_proto_goTypes = []interface{}{
	...
	(*v1.SearchRequest)(nil),        // 23: common.v1.SearchRequest
...
var file_notification_v1_notification_proto_depIdxs = []int32{
	...
	23, // 14: notification.v1.TemplateSearchRequest.data:type_name -> common.v1.SearchRequest
	3,  // 15: notification.v1.TemplateSearchResponse.data:type_name -> notification.v1.Template
	20, // 16: notification.v1.TemplateSaveRequest.data:type_name -> notification.v1.TemplateSaveRequest.DataEntry
	21, // 17: notification.v1.TemplateSaveRequest.extra:type_name -> notification.v1.TemplateSaveRequest.ExtraEntry
	3,  // 18: notification.v1.TemplateSaveResponse.data:type_name -> notification.v1.Template
	6,  // 19: notification.v1.NotificationService.Send:input_type -> notification.v1.SendRequest
	24, // 20: notification.v1.NotificationService.Status:input_type -> common.v1.StatusRequest
	25, // 21: notification.v1.NotificationService.StatusUpdate:input_type -> common.v1.StatusUpdateRequest
	8,  // 22: notification.v1.NotificationService.Release:input_type -> notification.v1.ReleaseRequest
	10, // 23: notification.v1.NotificationService.Receive:input_type -> notification.v1.ReceiveRequest
	23, // 24: notification.v1.NotificationService.Search:input_type -> common.v1.SearchRequest
	23, // 25: notification.v1.NotificationService.TemplateSearch:input_type -> common.v1.SearchRequest
	14, // 26: notification.v1.NotificationService.TemplateSave:input_type -> notification.v1.TemplateSaveRequest
	7,  // 27: notification.v1.NotificationService.Send:output_type -> notification.v1.SendResponse
	22, // 28: notification.v1.NotificationService.Status:output_type -> common.v1.StatusResponse
	26, // 29: notification.v1.NotificationService.StatusUpdate:output_type -> common.v1.StatusUpdateResponse
	9,  // 30: notification.v1.NotificationService.Release:output_type -> notification.v1.ReleaseResponse
	11, // 31: notification.v1.NotificationService.Receive:output_type -> notification.v1.ReceiveResponse
	5,  // 32: notification.v1.NotificationService.Search:output_type -> notification.v1.SearchResponse
	13, // 33: notification.v1.NotificationService.TemplateSearch:output_type -> notification.v1.TemplateSearchResponse
	15, // 34: notification.v1.NotificationService.TemplateSave:output_type -> notification.v1.TemplateSaveResponse
