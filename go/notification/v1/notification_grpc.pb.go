...
func (c *notificationServiceClient) Search(ctx context.Context, in *v1.SearchRequest, opts ...grpc.CallOption) (NotificationService_SearchClient, error) {
	...
	x := &notificationServiceSearchClient{ClientStream: stream}
...
func (c *notificationServiceClient) TemplateSearch(ctx context.Context, in *TemplateSearchRequest, opts ...grpc.CallOption) (NotificationService_TemplateSearchClient, error) {
	...
	x := &notificationServiceTemplateSearchClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func _NotificationService_Search_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(NotificationServiceServer).Search(m, &notificationServiceSearchServer{ServerStream: stream})
}
...
func _NotificationService_TemplateSearch_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(NotificationServiceServer).TemplateSearch(m, &notificationServiceTemplateSearchServer{ServerStream: stream})
}
