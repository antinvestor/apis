...
func (m *MockNotificationServiceClient) Receive(ctx context.Context, in *ReceiveRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ReceiveResponse], error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
	...
	ret0, _ := ret[0].(grpc.ServerStreamingClient[ReceiveResponse])
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockNotificationServiceClient) Release(ctx context.Context, in *ReleaseRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ReleaseResponse], error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(grpc.ServerStreamingClient[ReleaseResponse])
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockNotificationServiceClient) Send(ctx context.Context, in *SendRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SendResponse], error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(grpc.ServerStreamingClient[SendResponse])
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// Receive mocks base method.
func (m *MockNotificationServiceServer) Receive(arg0 *ReceiveRequest, arg1 grpc.ServerStreamingServer[ReceiveResponse]) error {
	m.ctrl.T.Helper()
...
// Release mocks base method.
func (m *MockNotificationServiceServer) Release(arg0 *ReleaseRequest, arg1 grpc.ServerStreamingServer[ReleaseResponse]) error {
	m.ctrl.T.Helper()
...
// Send mocks base method.
func (m *MockNotificationServiceServer) Send(arg0 *SendRequest, arg1 grpc.ServerStreamingServer[SendResponse]) error {
	m.ctrl.T.Helper()
