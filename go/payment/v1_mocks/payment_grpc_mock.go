...
import (
	...
	v10 "github.com/antinvestor/apis/go/payment/v1"
...
func (m *MockPaymentServiceClient) CreatePaymentLink(ctx context.Context, in *v10.CreatePaymentLinkRequest, opts ...grpc.CallOption) (*v10.CreatePaymentLinkResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
	...
	ret0, _ := ret[0].(*v10.CreatePaymentLinkResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockPaymentServiceClient) InitiatePrompt(ctx context.Context, in *v10.InitiatePromptRequest, opts ...grpc.CallOption) (*v10.InitiatePromptResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*v10.InitiatePromptResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockPaymentServiceClient) Receive(ctx context.Context, in *v10.ReceiveRequest, opts ...grpc.CallOption) (*v10.ReceiveResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*v10.ReceiveResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockPaymentServiceClient) Reconcile(ctx context.Context, in *v10.ReconcileRequest, opts ...grpc.CallOption) (*v10.ReconcileResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*v10.ReconcileResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockPaymentServiceClient) Release(ctx context.Context, in *v10.ReleaseRequest, opts ...grpc.CallOption) (*v10.ReleaseResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*v10.ReleaseResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockPaymentServiceClient) Search(ctx context.Context, in *v1.SearchRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[v10.SearchResponse], error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
func (m *MockPaymentServiceClient) Send(ctx context.Context, in *v10.SendRequest, opts ...grpc.CallOption) (*v10.SendResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
// CreatePaymentLink mocks base method.
func (m *MockPaymentServiceServer) CreatePaymentLink(arg0 context.Context, arg1 *v10.CreatePaymentLinkRequest) (*v10.CreatePaymentLinkResponse, error) {
	m.ctrl.T.Helper()
...
// InitiatePrompt mocks base method.
func (m *MockPaymentServiceServer) InitiatePrompt(arg0 context.Context, arg1 *v10.InitiatePromptRequest) (*v10.InitiatePromptResponse, error) {
	m.ctrl.T.Helper()
...
// Receive mocks base method.
func (m *MockPaymentServiceServer) Receive(arg0 context.Context, arg1 *v10.ReceiveRequest) (*v10.ReceiveResponse, error) {
	m.ctrl.T.Helper()
...
// Reconcile mocks base method.
func (m *MockPaymentServiceServer) Reconcile(arg0 context.Context, arg1 *v10.ReconcileRequest) (*v10.ReconcileResponse, error) {
	m.ctrl.T.Helper()
...
// Release mocks base method.
func (m *MockPaymentServiceServer) Release(arg0 context.Context, arg1 *v10.ReleaseRequest) (*v10.ReleaseResponse, error) {
	m.ctrl.T.Helper()
...
// Search mocks base method.
func (m *MockPaymentServiceServer) Search(arg0 *v1.SearchRequest, arg1 grpc.ServerStreamingServer[v10.SearchResponse]) error {
	m.ctrl.T.Helper()
...
// Send mocks base method.
func (m *MockPaymentServiceServer) Send(arg0 context.Context, arg1 *v10.SendRequest) (*v10.SendResponse, error) {
	m.ctrl.T.Helper()
