...
//
//	mockgen -source=/home/j/code/antinvestor/apis/go/payment/v1/payment_grpc.pb.go -package=paymentv1_mocks -destination=/home/j/code/antinvestor/apis/go/payment/v1_mocks/grpc/payment_grpc_mock.go
//
...
func (m *MockPaymentServiceClient) CreatePaymentLink(ctx context.Context, in *paymentv1.CreatePaymentLinkRequest, opts ...grpc.CallOption) (*paymentv1.CreatePaymentLinkResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
	...
	ret0, _ := ret[0].(*paymentv1.CreatePaymentLinkResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockPaymentServiceClient) InitiatePrompt(ctx context.Context, in *paymentv1.InitiatePromptRequest, opts ...grpc.CallOption) (*paymentv1.InitiatePromptResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*paymentv1.InitiatePromptResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockPaymentServiceClient) Receive(ctx context.Context, in *paymentv1.ReceiveRequest, opts ...grpc.CallOption) (*paymentv1.ReceiveResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*paymentv1.ReceiveResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockPaymentServiceClient) Reconcile(ctx context.Context, in *paymentv1.ReconcileRequest, opts ...grpc.CallOption) (*paymentv1.ReconcileResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*paymentv1.ReconcileResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockPaymentServiceClient) Release(ctx context.Context, in *paymentv1.ReleaseRequest, opts ...grpc.CallOption) (*paymentv1.ReleaseResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*paymentv1.ReleaseResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockPaymentServiceClient) Search(ctx context.Context, in *commonv1.SearchRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[paymentv1.SearchResponse], error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(grpc.ServerStreamingClient[paymentv1.SearchResponse])
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockPaymentServiceClient) Send(ctx context.Context, in *paymentv1.SendRequest, opts ...grpc.CallOption) (*paymentv1.SendResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*paymentv1.SendResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// CreatePaymentLink mocks base method.
func (m *MockPaymentServiceServer) CreatePaymentLink(arg0 context.Context, arg1 *paymentv1.CreatePaymentLinkRequest) (*paymentv1.CreatePaymentLinkResponse, error) {
	m.ctrl.T.Helper()
...
// InitiatePrompt mocks base method.
func (m *MockPaymentServiceServer) InitiatePrompt(arg0 context.Context, arg1 *paymentv1.InitiatePromptRequest) (*paymentv1.InitiatePromptResponse, error) {
	m.ctrl.T.Helper()
...
// Receive mocks base method.
func (m *MockPaymentServiceServer) Receive(arg0 context.Context, arg1 *paymentv1.ReceiveRequest) (*paymentv1.ReceiveResponse, error) {
	m.ctrl.T.Helper()
...
// Reconcile mocks base method.
func (m *MockPaymentServiceServer) Reconcile(arg0 context.Context, arg1 *paymentv1.ReconcileRequest) (*paymentv1.ReconcileResponse, error) {
	m.ctrl.T.Helper()
...
// Release mocks base method.
func (m *MockPaymentServiceServer) Release(arg0 context.Context, arg1 *paymentv1.ReleaseRequest) (*paymentv1.ReleaseResponse, error) {
	m.ctrl.T.Helper()
...
// Search mocks base method.
func (m *MockPaymentServiceServer) Search(arg0 *commonv1.SearchRequest, arg1 grpc.ServerStreamingServer[paymentv1.SearchResponse]) error {
	m.ctrl.T.Helper()
...
// Send mocks base method.
func (m *MockPaymentServiceServer) Send(arg0 context.Context, arg1 *paymentv1.SendRequest) (*paymentv1.SendResponse, error) {
	m.ctrl.T.Helper()
