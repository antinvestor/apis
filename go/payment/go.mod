...
require (
	...
	buf.build/gen/go/antinvestor/payment/connectrpc/go v1.19.1-20251115132429-8a4a049d9deb.2
	buf.build/gen/go/antinvestor/payment/protocolbuffers/go v1.36.10-20251115132429-8a4a049d9deb.1
