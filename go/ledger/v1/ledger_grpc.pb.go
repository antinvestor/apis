...
func (c *ledgerServiceClient) SearchLedgers(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (LedgerService_SearchLedgersClient, error) {
	...
	x := &ledgerServiceSearchLedgersClient{ClientStream: stream}
...
func (c *ledgerServiceClient) SearchAccounts(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (LedgerService_SearchAccountsClient, error) {
	...
	x := &ledgerServiceSearchAccountsClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (c *ledgerServiceClient) SearchTransactions(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (LedgerService_SearchTransactionsClient, error) {
	...
	x := &ledgerServiceSearchTransactionsClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (c *ledgerServiceClient) SearchTransactionEntries(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (LedgerService_SearchTransactionEntriesClient, error) {
	...
	x := &ledgerServiceSearchTransactionEntriesClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func _LedgerService_SearchLedgers_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(LedgerServiceServer).SearchLedgers(m, &ledgerServiceSearchLedgersServer{ServerStream: stream})
}
...
func _LedgerService_SearchAccounts_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(LedgerServiceServer).SearchAccounts(m, &ledgerServiceSearchAccountsServer{ServerStream: stream})
}
...
func _LedgerService_SearchTransactions_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(LedgerServiceServer).SearchTransactions(m, &ledgerServiceSearchTransactionsServer{ServerStream: stream})
}
...
func _LedgerService_SearchTransactionEntries_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(LedgerServiceServer).SearchTransactionEntries(m, &ledgerServiceSearchTransactionEntriesServer{ServerStream: stream})
}
