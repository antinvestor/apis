...
require (
	...
	buf.build/gen/go/antinvestor/ledger/connectrpc/go v1.19.1-20251216061453-9e40bd2db5e5.2
	buf.build/gen/go/antinvestor/ledger/protocolbuffers/go v1.36.11-20251216061453-9e40bd2db5e5.1
