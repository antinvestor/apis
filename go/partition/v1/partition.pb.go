...
const file_partition_v1_partition_proto_rawDesc = "" +
	...
	"\apage_id\x18\x01 \x01(\tB\x1e\xbaH\x1b\xd8\x01\x00r\x16\x10\x03\x18(2\x10[0-9a-z_-]{3,20}R\x06pageId\x12A\n" +
	"\fpartition_id\x18\x02 \x01(\tB\x1e\xbaH\x1b\xd8\x01\x00r\x16\x10\x03\x18(2\x10[0-9a-z_-]{3,20}R\vpartitionId\x12 \n" +
	"\x04name\x18\x03 \x01(\tB\f\xbaH\t\xd8\x01\x00r\x04\x10\x03\x18dR\x04name\"?\n" +
	...
	"\fpartition_id\x18\x01 \x01(\tB\x1e\xbaH\x1b\xd8\x01\x00r\x16\x10\x03\x18(2\x10[0-9a-z_-]{3,20}H\x00R\vpartitionId\x12=\n" +
	"\tclient_id\x18\x03 \x01(\tB\x1e\xbaH\x1b\xd8\x01\x00r\x16\x10\x03\x18(2\x10[0-9a-z_-]{3,20}H\x00R\bclientId\x12:\n" +
	"\n" +
	...
	"\taccess_id\x18\x01 \x01(\tB\x1e\xbaH\x1b\xd8\x01\x00r\x16\x10\x03\x18(2\x10[0-9a-z_-]{3,20}R\baccessId\x12C\n" +
	"\fpartition_id\x18\x02 \x01(\tB\x1e\xbaH\x1b\xd8\x01\x00r\x16\x10\x03\x18(2\x10[0-9a-z_-]{3,20}H\x00R\vpartitionId\x12=\n" +
	"\tclient_id\x18\x03 \x01(\tB\x1e\xbaH\x1b\xd8\x01\x00r\x16\x10\x03\x18(2\x10[0-9a-z_-]{3,20}H\x00R\bclientId\x12=\n" +
	"\n" +
	"profile_id\x18\x04 \x01(\tB\x1e\xbaH\x1b\xd8\x01\x00r\x16\x10\x03\x18(2\x10[0-9a-z_-]{3,20}R\tprofileIdB\x12\n" +
	...
	"\x04role\x18\x01 \x03(\v2\x1e.partition.v1.AccessRoleObjectR\x04role2\xf2\x10\n" +
