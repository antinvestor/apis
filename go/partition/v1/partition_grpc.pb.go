...
func (c *partitionServiceClient) ListTenant(ctx context.Context, in *ListTenantRequest, opts ...grpc.CallOption) (PartitionService_ListTenantClient, error) {
	...
	x := &partitionServiceListTenantClient{ClientStream: stream}
...
func (c *partitionServiceClient) ListPartition(ctx context.Context, in *ListPartitionRequest, opts ...grpc.CallOption) (PartitionService_ListPartitionClient, error) {
	...
	x := &partitionServiceListPartitionClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (c *partitionServiceClient) ListPartitionRole(ctx context.Context, in *ListPartitionRoleRequest, opts ...grpc.CallOption) (PartitionService_ListPartitionRoleClient, error) {
	...
	x := &partitionServiceListPartitionRoleClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (c *partitionServiceClient) ListAccessRole(ctx context.Context, in *ListAccessRoleRequest, opts ...grpc.CallOption) (PartitionService_ListAccessRoleClient, error) {
	...
	x := &partitionServiceListAccessRoleClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func _PartitionService_ListTenant_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(PartitionServiceServer).ListTenant(m, &partitionServiceListTenantServer{ServerStream: stream})
}
...
func _PartitionService_ListPartition_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(PartitionServiceServer).ListPartition(m, &partitionServiceListPartitionServer{ServerStream: stream})
}
...
func _PartitionService_ListPartitionRole_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(PartitionServiceServer).ListPartitionRole(m, &partitionServiceListPartitionRoleServer{ServerStream: stream})
}
...
func _PartitionService_ListAccessRole_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(PartitionServiceServer).ListAccessRole(m, &partitionServiceListAccessRoleServer{ServerStream: stream})
}
