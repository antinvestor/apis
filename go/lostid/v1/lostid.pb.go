...
const file_lostid_v1_lostid_proto_rawDesc = "" +
	...
	"\x04data\x18\x01 \x03(\v2\x19.lostid.v1.SearchResponseR\x04data\"\x96\x01\n" +
	...
	"\vTRANSACTION\x10\x022\xe2\x04\n" +
	"\rLostIdService\x12e\n" +
	"\vCollectible\x12\x1d.lostid.v1.CollectibleRequest\x1a\x1e.lostid.v1.CollectibleResponse\"\x17\x82\xd3\xe4\x93\x02\x11:\x01*\"\f/collectible\x12p\n" +
	"\x0fListCollectible\x12!.lostid.v1.ListCollectibleRequest\x1a\".lostid.v1.ListCollectibleResponse\"\x14\x82\xd3\xe4\x93\x02\x0e\x12\f/collectible0\x01\x12N\n" +
	"\x06Search\x12\x18.common.v1.SearchRequest\x1a\x19.lostid.v1.SearchResponse\"\x0f\x82\xd3\xe4\x93\x02\t\x12\a/search\x12^\n" +
	"\n" +
	"ListSearch\x12\x1c.lostid.v1.ListSearchRequest\x1a\x1d.lostid.v1.ListSearchResponse\"\x11\x82\xd3\xe4\x93\x02\v\x12\t/searches0\x01\x12V\n" +
	"\bProgress\x12\x1a.lostid.v1.ProgressRequest\x1a\x1b.lostid.v1.ProgressResponse\"\x11\x82\xd3\xe4\x93\x02\v\x12\t/progress\x12p\n" +
	"\x0fListTransaction\x12!.lostid.v1.ListTransactionRequest\x1a\".lostid.v1.ListTransactionResponse\"\x14\x82\xd3\xe4\x93\x02\x0e\x12\f/transaction0\x01B\xb2\x03\x92A\x82\x02\x12o\n" +
	"\x0fLost ID Service\"W\n" +
	...
	"\n" +
	"\x06bearer\x12\x00\n" +
	"\x1ecom.antinvestor.apis.lostid.v1B\vLostidProtoP\x01Z8github.com/antinvestor/apis/go/lostid/lostid/v1;lostidv1\xa2\x02\x03LXX\xaa\x02\tLostid.V1\xca\x02\tLostid\\V1\xe2\x02\x15Lostid\\V1\\GPBMetadata\xea\x02\n" +
