...
require (
	buf.build/gen/go/antinvestor/chat/connectrpc/go v1.19.1-20260102073726-f7003bf1d54c.2
	buf.build/gen/go/antinvestor/chat/protocolbuffers/go v1.36.11-20260102073726-f7003bf1d54c.1
