...
require (
	buf.build/gen/go/antinvestor/chat/connectrpc/go v1.19.1-20251222125201-1e39ae8b88d4.2
	buf.build/gen/go/antinvestor/chat/protocolbuffers/go v1.36.11-20251222125201-1e39ae8b88d4.1
