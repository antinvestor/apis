...
const (
	...
	ChatService_UpdateClientState_FullMethodName       = "/chat.v1.ChatService/UpdateClientState"
	ChatService_GetClientState_FullMethodName          = "/chat.v1.ChatService/GetClientState"
)
...
type ChatServiceClient interface {
	...
	UpdateClientState(ctx context.Context, in *UpdateClientStateRequest, opts ...grpc.CallOption) (*UpdateClientStateResponse, error)
...
func (c *chatServiceClient) UpdateClientState(ctx context.Context, in *UpdateClientStateRequest, opts ...grpc.CallOption) (*UpdateClientStateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateClientStateResponse)
	err := c.cc.Invoke(ctx, ChatService_UpdateClientState_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatServiceClient) GetClientState(ctx context.Context, in *GetClientStateRequest, opts ...grpc.CallOption) (*GetClientStateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetClientStateResponse)
	err := c.cc.Invoke(ctx, ChatService_GetClientState_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ChatServiceServer interface {
	...
	// Update different states that the client can be in for room subscriptions awareness
	UpdateClientState(context.Context, *UpdateClientStateRequest) (*UpdateClientStateResponse, error)
	// Get client state for a set of profiles in a room
...
func (UnimplementedChatServiceServer) UpdateClientState(context.Context, *UpdateClientStateRequest) (*UpdateClientStateResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateClientState not implemented")
}
func (UnimplementedChatServiceServer) GetClientState(context.Context, *GetClientStateRequest) (*GetClientStateResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetClientState not implemented")
}
...
func _ChatService_UpdateClientState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateClientStateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatServiceServer).UpdateClientState(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChatService_UpdateClientState_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).UpdateClientState(ctx, req.(*UpdateClientStateRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ChatService_GetClientState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetClientStateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatServiceServer).GetClientState(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChatService_GetClientState_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).GetClientState(ctx, req.(*GetClientStateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ChatService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateClientState",
			Handler:    _ChatService_UpdateClientState_Handler,
		},
		{
			MethodName: "GetClientState",
			Handler:    _ChatService_GetClientState_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		{
