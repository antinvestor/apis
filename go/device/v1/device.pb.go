...
const file_device_v1_device_proto_rawDesc = "" +
	...
	"\x05extra\x18\x04 \x01(\v2\x17.google.protobuf.StructR\x05extra\"\x9c\x03\n" +
	"\tDeviceLog\x12+\n" +
	"\x02id\x18\x01 \x01(\tB\x1b\xbaH\x18r\x16\x10\x03\x18(2\x10[0-9a-z_-]{3,20}R\x02id\x128\n" +
	"\tdevice_id\x18\x02 \x01(\tB\x1b\xbaH\x18r\x16\x10\x03\x18(2\x10[0-9a-z_-]{3,20}R\bdeviceId\x12=\n" +
	"\n" +
	"session_id\x18\x03 \x01(\tB\x1e\xbaH\x1b\xd8\x01\x01r\x16\x10\x03\x18(2\x10[0-9a-z_-]{3,20}R\tsessionId\x12\x0e\n" +
	...
	"\x10NOTIFICATION_KEY\x10\x012\x80\b\n" +
	"\rDeviceService\x12O\n" +
	...
	":\x01*2\x05/{id}\x12N\n" +
	"\x04Link\x12\x16.device.v1.LinkRequest\x1a\x17.device.v1.LinkResponse\"\x15\x82\xd3\xe4\x93\x02\x0f:\x01*2\n" +
	"/link/{id}\x12L\n" +
